...
### A máquina Enigma {#sec-01-enigma}
...
6. A **Enigma** mecanizou o princípio polialfabético a uma escala industrial, substituindo a palavra-chave curta da Vigenère por rotores electromecânicos; caiu não à análise de frequência, mas a uma falha estrutural do desenho combinada com palavras prováveis ("*crib*") testadas em escala pela Bombe
7. As **cifras de transposição** reordenam os símbolos do texto claro sem alterar a sua identidade, sendo a base histórica dos conceitos modernos de confusão e difusão
