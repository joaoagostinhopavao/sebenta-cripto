...
![O modelo de cifra simétrica: emissor e receptor partilham previamente a mesma chave secreta, através de um canal seguro. O algoritmo de cifragem usa essa chave para transformar o texto claro em texto cifrado; o algoritmo de decifragem, usando a mesma chave, reverte a transformação.](../assets/images/fig-01-modelo-cifra-simetrica.png){#fig-01-modelo-simetrico}
...
![Frequência das letras em português, contada sobre os três primeiros cantos d'Os Lusíadas.](../assets/images/fig-01-frequencia-letras-pt.png){#fig-01-frequencia-letras}
...
![Grelha de Playfair construída a partir da palavra-chave "REDIAL".](../assets/images/fig-01-playfair-grelha.png){#fig-01-playfair-grelha width=44%}
...
![A cifra de Vernam: um gerador de fluxo de chave produz a sequência $k_i$, combinada por XOR com o texto claro na cifragem, e com o texto cifrado na decifragem — a mesma operação em ambos os sentidos.](../assets/images/fig-01-vernam-gerador.png){#fig-01-vernam-gerador width=95%}
...
![A técnica rail fence: o texto claro escreve-se em ziguezague por duas linhas; o texto cifrado lê-se linha a linha.](../assets/images/fig-01-rail-fence.png){#fig-01-rail-fence width=80%}
...
![Grelha de transposição colunar com a chave "REDIAL". O número entre parêntesis, por baixo de cada letra da chave, indica a ordem alfabética dessa letra e, por isso, a ordem de leitura da respectiva coluna.](../assets/images/fig-01-transposicao-grelha.png){#fig-01-transposicao-grelha width=60%}
